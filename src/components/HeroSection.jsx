...
export default function HeroSection() {
  ...
  return (
    <section
      id="hero"
      className="relative min-h-[85vh] sm:min-h-screen max-h-[520px]:min-h-screen pt-20 sm:pt-24 max-h-[520px]:pt-12 pb-10 sm:pb-12 max-h-[520px]:pb-3 px-4 sm:px-6 flex flex-col justify-center items-center text-center bg-gradient-to-b from-[#160420] via-[#2A0C3D] to-[#160420] text-[#FAF2ED] overflow-hidden"
    >
      ...
      <div className="max-w-4xl mx-auto w-full z-10 flex flex-col items-center">
        ...
        <motion.div
          ...
          className="mb-4 max-h-[520px]:mb-1"
        >
          <p className="font-arabic text-2xl sm:text-4xl max-h-[520px]:text-xl text-[#E8D4C5] arabic-gold tracking-wider mb-2 max-h-[520px]:mb-0.5 font-normal leading-relaxed">
            {bismillah.arabic}
          </p>
        ...
        <IslamicArchDivider className="my-3 max-h-[520px]:my-1" />
        ...
        <motion.span
          ...
          className="inline-flex items-center gap-2 text-xs max-h-[520px]:text-[10px] font-bold uppercase tracking-[0.3em] text-[#E8D4C5] bg-[#E8D4C5]/10 px-4 py-1.5 max-h-[520px]:py-0.5 rounded-full border border-[#E8D4C5]/40 mb-4 max-h-[520px]:mb-1"
        >
        ...
        <motion.div
          ...
          className="flex flex-col md:flex-row max-h-[520px]:flex-row items-center justify-center gap-2 md:gap-6 max-h-[520px]:gap-3 my-1 max-h-[520px]:my-0.5"
        >
          <h1 className="font-display text-4xl sm:text-5xl md:text-6xl lg:text-7xl max-h-[520px]:text-2xl font-bold tracking-wider gold-shimmer-text py-1 max-h-[520px]:py-0">
            {groom.shortName}
          </h1>
        ...
        <motion.div
          ...
          className="grid grid-cols-1 sm:grid-cols-3 max-h-[520px]:grid-cols-3 gap-4 sm:gap-8 max-h-[520px]:gap-2 max-w-2xl w-full my-6 max-h-[520px]:my-1.5 py-4 max-h-[520px]:py-1.5 px-5 max-h-[520px]:px-3 rounded-2xl bg-[#250A36]/95 border border-[#E8D4C5]/60 shadow-xl"
        >
