    ...
    >
      <div className="w-full max-w-lg flex flex-col items-center justify-center py-2">
        ...
        <motion.div
          ...
          className="my-2 md:my-1 z-30 cursor-pointer flex items-center justify-center transform-gpu"
        >
          <FSMonogramCalligraphy className="h-28 md:h-24 lg:h-28 w-auto" />
        </motion.div>
        ...
        >
          <span className="text-[11px] sm:text-xs font-bold uppercase tracking-[0.3em] text-[#E8D4C5] bg-[#E8D4C5]/10 px-4 py-1.5 rounded-full border border-[#E8D4C5]/40 my-3 md:my-2 shadow-xs">
            The Wedding Reception
          </span>

          {/* Couple First Names with Gold Shimmer Typography */}
          <h1 className="font-display text-3xl sm:text-4xl md:text-3xl lg:text-4xl text-[#FAF2ED] font-bold tracking-wider my-2 md:my-1.5 leading-tight gold-shimmer-text">
            {groom.shortName} <span className="font-script text-[#E8D4C5] font-normal text-4xl sm:text-5xl md:text-4xl mx-1.5">&amp;</span> {bride.shortName}
          </h1>

          <IslamicArchDivider className="my-3 md:my-2" />
